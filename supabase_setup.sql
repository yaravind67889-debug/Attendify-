-- =====================================================================
-- SUPABASE POSTGRESQL SCHEMA FOR COLLEGE ATTENDANCE SYSTEM (ATTENDIFY)
-- Copy and run this script in the Supabase SQL Editor to configure all tables.
-- =====================================================================
...
-- Seed default sign-up passcode setting (Leave empty or configure a default passcode)
-- If seeded, students must provide this passcode to complete registration.
-- Example default: 'PASSCODE123' (Uncomment the line below if you want to set a default passcode)
-- INSERT INTO settings (key, value) VALUES ('signup_lock_password', 'PASSCODE123') ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value;
